							...
							<table class="insert-tab" width="100%">
								<tbody>
									...
									<tr>
										...
										<td>
											<input class="common-text required" id="chepai" name="chepai"
												size="50" value="" type="text">
										</td>
									</tr>
									...
									<tr>
										<th>
											<i class="require-red"></i>添加时间：
										</th>
										<td><input class="common-text" placeholder="时间"
												   name="tjdate" id="tjdate" value=""  type="text" class="Wdate"
